...
router.post("/schedule",encoder,function(req,res){
...
router.get("/schedule/operation",function(req,res){
    let room = [];
    let doctorName = [];
    let department = [];
    let patientName = [];
...
router.post("/schedule/operation",encoder,function(req,res){
    global.date;
    date = req.body.date;
    let dateSplit = date.split('-');
    taiwanYear = parseInt(dateSplit[0])-1911;
...
router.get("/schedule/operation/data", function(req, res) {
